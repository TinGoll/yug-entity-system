...
export interface ObjectIndicators {
  ...
  is_not_sent_notification?: boolean;
...
export interface EntityDto
  extends Omit<Partial<ApiEntity>, "id" | "key" | "index" | "indicators"> {
  name: string;
}

export interface ComponentDto
  extends Omit<Partial<ApiComponent>, "id" | "key" | "index" | "indicators"> {
  componentName: string;
}
export interface PropertyDto
  extends Omit<
    Partial<ApiComponent>,
    | "id"
    | "key"
    | "index"
    | "indicators"
